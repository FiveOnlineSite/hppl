...
export const metadata: Metadata = {
  title: "Export Inquiry | Hindustan Pencils",
  description:
    "Become an exporter of Hindustan Pencils' stationery products and join a decades-long legacy.",
};
...
export default function ExportInquiryPage() {
  return (
    <InquiryPageShell description="Join Hindustan Pencils' global network and help take our trusted stationery products to new markets. Please share your business details below.">
      <InquiryFormShell action="/api/export-inquiry" submitLabel="Submit Inquiry">
